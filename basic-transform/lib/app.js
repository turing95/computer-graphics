...
function InitTransforms() {
	...
	sTransformText[0] = "Translate of +2 on the x axis, and -1 on the y axis";
	sTransform[0] = utils.MakeTranslateMatrix(2,-1,0);
	
	sTransformText[1] = "Rotate of 45 degrees on the x axis";
	sTransform[1] = utils.MakeRotateXMatrix(45);
	
	sTransformText[2] = "Make the object 2 times smaller";
	sTransform[2] = utils.MakeScaleMatrix(0.5);
	
	sTransformText[3] = "Make the object 2 times longer on the z axis, and half on the other axis";
	sTransform[3] = utils.MakeScaleNuMatrix(0.5, 0.5, 2);
	       
	sTransformText[4] = "Mirror over the z axis";
	sTransform[4] = utils.MakeScaleNuMatrix(-1, -1, 1);
	       
	sTransformText[5] = "Flatten over the z axis";
	sTransform[5] = utils.MakeScaleNuMatrix(1, 1, 0);
	       
	sTransformText[6] = "Make a shear along the Y axis, with a factor of 1 along the x axis";
	sTransform[6] = utils.MakeShearYMatrix(1, 0);
